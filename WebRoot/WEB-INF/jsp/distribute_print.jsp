...
<body style="background: none">
    ...
    <br/>
	<br/>
	<div align="center"> <H1>分&nbsp;&nbsp;&nbsp;&nbsp;发&nbsp;&nbsp;&nbsp;&nbsp;单</H1></div>
<div align="center">
	<table width="100%x" align="center" >
		<tr>
			<td  align="center" >分发至:${requestScope.subName}</td>
	...
	<div  style ="width:100%">
	 ...
	 <br/>
	 <br/>
	 <div><input type="button" class="btn1" value="打印" onclick="window.history.go(-1);" style="width:100px;font-size:16px;font-weight:bold;position:absolute;left:500px;"/></div>
	 <div><input type="button" class="btn" value="返回" onclick="window.history.go(-1);" style="width:100px;font-size:16px;font-weight:bold;"/></div>
</div>
</body>
</html>
