...
<body style="background: none">
	<div class="top-bar">
				...
				<h1>请选择您需要退回的商品</h1>
				<div class="breadcrumbs"><a href="index.html" target="_top">首页</a> / <a href="index.html">客户服务中心</a></div>
			</div>
			<div class="select-bar"/>
			<div class="table" style="width:950px;">
				...
				<table id="tt" class="easyui-datagrid" style="width:950px;">					
				</table>
				<div align="right" style="width:85%;">
					<input type="button" class="button" onclick="back();" value="上一步"/>
					<input type="button" class="button" onclick="checkType('delProducts1.html');" value="下一步"/>
				</div>
			</div>
</body>
</html>
