...
var total;
	$(function(){	
		...
		$.ajax({
			url:"orderUser.html",
			data:{upper:10,lower:1,userid:userid,osname:osname},
			type:"post",
	...
	$("#tt").datagrid({
		...
		$(p).pagination({
			onSelectPage : function(pageNumber,pageSize){
				...
				$.ajax({
					url:"orderUser.html",
					data:{upper:pageNumber * pageSize,lower:(pageNumber - 1) * pageSize + 1,userid:userid,osname:osname,proname:proname,createdate:createdate},
					type:"post",
					success:function(json){
						total=json.total;
						json=json.list;
