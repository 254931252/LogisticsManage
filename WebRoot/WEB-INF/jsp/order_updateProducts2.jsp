...
<head>
	...
	<script type="text/javascript">
		...
		function check(){
			var remark = document.frm7.remark.value;
			var orderformGenerateDate = document.frm7.orderformGenerateDate.value;
			var operatorId = document.frm7.operatorId.value;
			if(remark==null||remark==""){
				alert("换货原因不能为空！");
				document.frm7.remark.focus();
				return false;
			}
			if(orderformGenerateDate==null||orderformGenerateDate==""){
				alert("要求换货时间不能为空！");
				document.frm7.orderformGenerateDate.focus();
				return false;
			}
			if(operatorId==null||operatorId==""){
				alert("操作员不能为空！");
				document.frm7.operatorId.focus();
				return false;
			}
			window.location='order_search.html'
		}
	</script>
</head>
...
<form name="frm7" method="post">
	<div class="table">
		...
		<table class="listing form" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td class="first">换货原因(*)</td>
				<td><input name="remark" type="text" class="text" value="尺码不合"/></td>
				<td>要求换货日期(*)</td>
				<td class="last"><input name="orderformGenerateDate" type='text' class="date-six text" name='' readonly/></td>
			</tr>
			<tr>
		...
		<div align="center" style="width:100%;">
			...
			<input type="button" class="button" onclick="check()" value=" 换 货 "/>
		</div>
	</div>
</form>
</body>
