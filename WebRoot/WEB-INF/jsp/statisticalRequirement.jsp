	...
	<div style="width:100%;position:relative;" >
		<div id="p" class="easyui-panel" title="库存查询"
			...
			<div style="position:absolute;top:300px;left:80px;">
				商品名称 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="text" class="easyui-textbox" id="proName" />
			</div>
			<div style="position:absolute; margin-right: 30px;margin-top: 15px;top:283px;left:350px;">
				<a id="btn" >查询</a>
			</div>
...
<script language="javascript">
	...
	function changePicture(){
		...
		$('#srPic').attr("src","changeTheChart.html?type=" + type + "&typeName=" + typeName + "&startDate="
			+ startDate + "&endDate=" + endDate + "&proName=" + proName + "&" + Math.random());
	}
	$(function(){
