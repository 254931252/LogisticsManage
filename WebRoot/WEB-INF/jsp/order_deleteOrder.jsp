...
<head>
	...
	<script type="text/javascript">
		...
		function check(){
			var remark = document.frm5.remark.value;
			var orderformGenerateDate = document.frm5.orderformGenerateDate.value;
			var operatorId = document.frm5.operatorId.value;
			if(remark==null||remark==""){
				alert("退订原因不能为空！");
				document.frm5.remark.focus();
				return false;
			}
			if(orderformGenerateDate==null||orderformGenerateDate==""){
				alert("退订时间不能为空！");
				document.frm5.orderformGenerateDate.focus();
				return false;
			}
			if(operatorId==null||operatorId==""){
				alert("操作员不能为空！");
				document.frm5.operatorId.focus();
				return false;
			}
...
$(function(){
	...
	$("#tt").datagrid({
		...
		function update(userid){			
			window.location.href="order_deleteOreder.html?userid="+userid;//执行删除订单方法
		}
</script>
