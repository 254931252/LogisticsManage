...
<div class="intro-container">
  ...
  <div class="button shift-camera-button" >
    ...
    <div class="text" >登录入口</div>
  </div>
</div>
<div class="sky-container">

  <div class="text-right sky-container__left">
  <div style="margin: 0; padding: 0; width: 503px; height: 206px; background-color: transparent; position: absolute; right: 155px; top: 138px;">
  <form  method="post">
  <table width="478" height="200px" border="0" >
  <tr>
    <td width="72" height="68">&nbsp;</td>
    <td width="80" style="color:#FFF">用户名：</td>
  ...
  <tr>
    <td height="50">&nbsp;</td>
    <td align="right"><input type="button" name="btn" style="color:#FFF; background-color:transparent" value="登录"/></td>
    <td width="100">&nbsp;</td>
    <td width="77"><input type="reset" style="color:#FFF; background-color:transparent" value="取消"/></td>
    <td>&nbsp;</td>
    <td width="77"></td>
  </tr>
  </table>
...
$(function(){
	...
	$("[name=btn]").click(function(){
		...
		if(userName.length!=0&&userName!=null&&userPass.length!=0&&userPass!=null){
			$.ajax({
